...
- Дополнительное решение, подготовленное после завершения соервнования:
...
# Рассмотрим этапы исследования, которое дает f1-score = 0.7036
...
# Рассмотрим этапы исследования, которое дает f1-score = 0.6497
