...
3. Объединим признаковое пространство
4. Разобъем данные на train и test
5. Выберем наиболее сильные признаки
6. Моделируем с Light GBM на train и рассчитываем порог отсечения по вероятности принадлежности объекта к классу 0 или 1
7. Валидируем модель на test и проводим кросс-валидацию на train
8. Контрольная проверка модели
9. Отправка результатов моделирования на площадку
