...
# Есть несколько решений задачи (Jupyter Notebook):
 - Одно из первых, без использоваиня "запрещенного приема":  
 *Название файла: **201206_pap_true_score.ipynb***  
 *f1-score = **0.4441***  
 *Файл с правильными ответами - baseline_submission.csv*

 - Еще одно из первых, без использоваиня "запрещенного приема":  
 *Название файла: **201208_pap_true_score_1.ipynb***  
 *f1-score = **0.5346***
...
# Рассмотрим решение с f1-score = 0.65
## Этапы исследования
